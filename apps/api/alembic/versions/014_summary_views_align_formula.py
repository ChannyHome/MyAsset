"""014 align summary views with analytics summary formula

Revision ID: 014_summary_views_align_formula
Revises: 013_summary_gross_return_metrics
...
revision = "014_summary_views_align_formula"
down_revision = "013_summary_gross_return_metrics"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    # Revert to previous v013 formula.
    op.execute(
        """
        CREATE VIEW v_user_summary_v2 AS
        SELECT
