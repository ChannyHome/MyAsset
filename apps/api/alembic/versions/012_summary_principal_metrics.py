"""012 add principal and return metrics to summary views

Revision ID: 012_summary_principal_metrics
Revises: 011_portfolio_networth_view
Create Date: 2026-02-15 05:35:00
"""

from alembic import op


revision = "012_summary_principal_metrics"
down_revision = "011_portfolio_networth_view"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # revert to previous definitions from 010/009
    op.execute("DROP VIEW IF EXISTS v_household_summary_v2")
    op.execute("DROP VIEW IF EXISTS v_user_summary_v2")
