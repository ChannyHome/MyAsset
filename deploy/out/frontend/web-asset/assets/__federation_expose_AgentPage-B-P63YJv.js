...
const _hoisted_217 = { class: "flex min-w-max flex-nowrap gap-1" };
...
const _hoisted_223 = { class: "mt-3 flex flex-wrap items-center justify-between gap-2 text-xs text-slate-600 dark:text-slate-300" };
                  ...
                  _createElementVNode("tbody", null, [
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolioRows.value, (item) => {
                      return _openBlock(), _createElementBlock("tr", {
                        ...
                        _createElementVNode("td", _hoisted_194, _toDisplayString(item.id), 1),
                        _createElementVNode("td", _hoisted_195, _toDisplayString(item.name), 1),
                        _createElementVNode("td", _hoisted_196, _toDisplayString(item.type), 1),
                        _createElementVNode("td", _hoisted_197, _toDisplayString(item.category || "-"), 1),
                        _createElementVNode("td", _hoisted_198, _toDisplayString(item.exchange_code || "-"), 1),
                        _createElementVNode("td", _hoisted_199, _toDisplayString(item.base_currency), 1),
                        _createElementVNode("td", _hoisted_200, _toDisplayString(item.is_included ? "Y" : "N"), 1),
                        _createElementVNode("td", _hoisted_201, _toDisplayString(item.is_hidden ? "Y" : "N"), 1),
                        _createElementVNode("td", _hoisted_202, _toDisplayString(formatMoney(item.cumulative_deposit_amount, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_203, _toDisplayString(formatMoney(item.cumulative_withdrawal_amount, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_204, _toDisplayString(formatPortfolioPrincipalNet(item)), 1),
                        _createElementVNode("td", _hoisted_205, _toDisplayString(formatMoney(item.gross_assets_total, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_206, _toDisplayString(formatMoney(item.liabilities_total, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_207, _toDisplayString(formatMoney(item.net_assets_total, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_208, _toDisplayString(formatMoney(item.debt_adjusted_principal_total ?? item.principal_minus_debt_total, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_209, _toDisplayString(formatMoney(item.net_assets_profit_total, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_210, _toDisplayString(formatPct(item.net_assets_return_pct)), 1),
                        _createElementVNode("td", _hoisted_211, _toDisplayString(formatMoney(item.portfolio_profit_total ?? item.total_pnl_amount, item.base_currency)), 1),
                        _createElementVNode("td", _hoisted_212, _toDisplayString(formatPct(item.total_return_pct)), 1),
                        _createElementVNode("td", _hoisted_213, _toDisplayString(item.holding_count), 1),
                        _createElementVNode("td", _hoisted_214, _toDisplayString(item.liability_count), 1),
                        _createElementVNode("td", _hoisted_215, _toDisplayString(formatDateTime(item.updated_at)), 1),
                        _createElementVNode("td", _hoisted_216, [
                          _createElementVNode("div", _hoisted_217, [
                            ...
                            }, _toDisplayString(item.is_included ? "Exclude" : "Include"), 9, _hoisted_219),
                            _createElementVNode("button", {
                              type: "button",
                              class: "rounded border border-slate-300 px-2 py-0.5 hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-800",
                              disabled: !canManageAssets.value || isBusy.value,
                              onClick: ($event) => togglePortfolioHidden(item)
                            }, _toDisplayString(item.is_hidden ? "Unhide" : "Hide"), 9, _hoisted_220),
                            _createElementVNode("button", {
                              type: "button",
            ...
            _createElementVNode("div", _hoisted_438, [
              _createElementVNode("label", _hoisted_439, [
                ...
                _withDirectives(_createElementVNode("select", {
                  ...
                  _cache[320] || (_cache[320] = _createElementVNode("option", { value: "" }, "Unassigned", -1)),
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sortedHoldingPortfolioOptions.value, (item) => {
                    return _openBlock(), _createElementBlock("option", {
                      key: item.id,
                      value: String(item.id)
