...
const {createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,normalizeStyle:_normalizeStyle,createTextVNode:_createTextVNode,normalizeClass:_normalizeClass,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,renderList:_renderList,Fragment:_Fragment} = await importShared('vue');
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props) {
    ...
    const amountMaskStyle = computed(() => props.maskAmounts ? { filter: "blur(6px)" } : void 0);
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", _hoisted_1, [
        _createElementVNode("article", _hoisted_2, [
          ...
          _createElementVNode("p", _hoisted_4, [
            ...
            }, _toDisplayString(formatCurrency(__props.grossAssetsTotal, __props.displayCurrency)), 5),
            _createElementVNode("span", {
              ...
              _createElementVNode("span", {
                style: _normalizeStyle(amountMaskStyle.value)
              }, _toDisplayString(formatSignedCurrency(__props.principalProfitTotal, __props.displayCurrency)), 5),
          ...
          _createElementVNode("p", _hoisted_5, [
            ...
            _createElementVNode("span", {
              style: _normalizeStyle(amountMaskStyle.value)
            }, "(" + _toDisplayString(formatCurrency(__props.investedPrincipalTotal, __props.displayCurrency)) + ")", 5)
          ]),
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(grossPortfolioRows.value, (row) => {
                    return _openBlock(), _createElementBlock("tr", {
                      ...
                      _createElementVNode("td", _hoisted_13, [
                        _createElementVNode("span", {
                          style: _normalizeStyle(amountMaskStyle.value)
                        }, _toDisplayString(formatCurrency(toNumber(row.gross_assets_total), row.base_currency || __props.displayCurrency)), 5)
                      ]),
        ...
        _createElementVNode("article", _hoisted_15, [
          ...
          _createElementVNode("p", _hoisted_17, [
            _createElementVNode("span", {
              style: _normalizeStyle(amountMaskStyle.value)
            }, _toDisplayString(formatCurrency(__props.liabilitiesTotal, __props.displayCurrency)), 5)
          ]),
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sortedLiabilityRows.value, (row) => {
                    return _openBlock(), _createElementBlock("tr", {
                      ...
                      _createElementVNode("td", _hoisted_25, [
                        _createElementVNode("span", {
                          style: _normalizeStyle(amountMaskStyle.value)
                        }, _toDisplayString(formatCurrency(toNumber(row.outstanding_balance), row.currency || __props.displayCurrency)), 5)
                      ])
                    ]);
                  }), 128))
                ])
        ...
        _createElementVNode("article", _hoisted_26, [
          ...
          _createElementVNode("p", _hoisted_28, [
            _createElementVNode("span", {
              style: _normalizeStyle(amountMaskStyle.value)
            }, _toDisplayString(formatCurrency(__props.netAssetsTotal, __props.displayCurrency)), 5),
            _createElementVNode("span", {
              ...
              _createElementVNode("span", {
                style: _normalizeStyle(amountMaskStyle.value)
              }, _toDisplayString(formatSignedCurrency(__props.netAssetsProfitTotal, __props.displayCurrency)), 5),
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(netPortfolioRows.value, (row) => {
                    return _openBlock(), _createElementBlock("tr", {
                      ...
                      _createElementVNode("td", _hoisted_37, [
                        _createElementVNode("span", {
                          style: _normalizeStyle(amountMaskStyle.value)
                        }, _toDisplayString(formatCurrency(toNumber(row.net_assets_total), row.base_currency || __props.displayCurrency)), 5)
                      ]),
                      ...
                      _createElementVNode("td", {
                        ...
                        _createElementVNode("span", {
                          style: _normalizeStyle(amountMaskStyle.value)
                        }, _toDisplayString(formatSignedCurrency(toNumber(row.net_assets_profit_total), row.base_currency || __props.displayCurrency)), 5)
                      ], 2),
                      _createElementVNode("td", {
