...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-B0VebYHs.js', import.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-BRtULNWI.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-BVL2lg4a.js', import.meta.url).href),import:true}};
