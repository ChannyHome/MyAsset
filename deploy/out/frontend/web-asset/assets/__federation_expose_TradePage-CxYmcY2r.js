...
const _hoisted_47 = { class: "block text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_48 = { class: "grid grid-cols-1 gap-2 md:grid-cols-2" };
const _hoisted_49 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_50 = ["disabled"];
const _hoisted_51 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_52 = { class: "flex flex-wrap items-center gap-2" };
const _hoisted_53 = ["disabled"];
const _hoisted_54 = { class: "group relative inline-flex items-center gap-1" };
const _hoisted_55 = ["disabled"];
const _hoisted_56 = { class: "pointer-events-none absolute left-0 top-full z-20 mt-2 hidden w-[24rem] rounded-xl border border-slate-200 bg-white/95 p-3 text-xs text-slate-700 shadow-xl backdrop-blur-sm group-hover:block group-focus-within:block dark:border-slate-700 dark:bg-slate-900/95 dark:text-slate-200" };
const _hoisted_57 = { class: "mt-2 list-disc space-y-1 pl-4" };
const _hoisted_58 = { class: "rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900" };
...
const _hoisted_62 = { class: "flex flex-wrap items-center gap-2" };
const _hoisted_63 = {
  key: 0,
  class: "space-y-3"
};
const _hoisted_64 = { class: "grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4" };
...
const _hoisted_69 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_70 = { class: "block text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_71 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_72 = ["disabled"];
const _hoisted_73 = { class: "rounded-lg border border-slate-300 bg-slate-50/70 px-3 py-2 text-xs dark:border-slate-700 dark:bg-slate-950/50" };
const _hoisted_74 = { class: "flex items-center justify-between gap-2" };
const _hoisted_75 = {
  key: 0,
...
const _hoisted_78 = { class: "grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4" };
const _hoisted_79 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_80 = ["value"];
const _hoisted_81 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
...
const _hoisted_84 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_85 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_86 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_87 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_88 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_89 = {
  key: 0,
...
const _hoisted_90 = { class: "block text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_91 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_92 = ["disabled"];
const _hoisted_93 = { class: "rounded-lg border border-slate-300 bg-slate-50/70 px-3 py-2 text-xs dark:border-slate-700 dark:bg-slate-950/50" };
const _hoisted_94 = { class: "flex items-center justify-between gap-2" };
const _hoisted_95 = {
  key: 0,
  class: "mt-1 space-y-1 text-slate-700 dark:text-slate-200"
};
...
const _hoisted_98 = { class: "grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4" };
...
const _hoisted_101 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_102 = ["value"];
const _hoisted_103 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_104 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_105 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_106 = { class: "block text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_107 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_108 = ["disabled"];
const _hoisted_109 = { class: "rounded-lg border border-slate-300 bg-slate-50/70 px-3 py-2 text-xs dark:border-slate-700 dark:bg-slate-950/50" };
...
const _hoisted_114 = { class: "grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4" };
...
const _hoisted_117 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_118 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_119 = { class: "mt-1 flex items-center gap-2" };
const _hoisted_120 = { class: "text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_121 = { class: "block text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" };
const _hoisted_122 = { class: "inline-flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm dark:border-slate-700" };
const _hoisted_123 = ["disabled"];
const _hoisted_124 = { class: "rounded-lg border border-slate-300 bg-slate-50/70 px-3 py-2 text-xs dark:border-slate-700 dark:bg-slate-950/50" };
const _hoisted_125 = { class: "flex items-center justify-between gap-2" };
const _hoisted_126 = {
  key: 0,
  class: "mt-1 space-y-1 text-slate-700 dark:text-slate-200"
};
...
const _hoisted_130 = { class: "rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900" };
const _hoisted_131 = { class: "flex items-start justify-between gap-3" };
const _hoisted_132 = ["aria-expanded"];
const _hoisted_133 = {
  key: 0,
  class: "mt-3 space-y-3"
};
const _hoisted_134 = { class: "flex flex-wrap items-center gap-2" };
const _hoisted_135 = { class: "grid grid-cols-1 gap-2 md:grid-cols-2 xl:grid-cols-8" };
const _hoisted_136 = ["value"];
const _hoisted_137 = ["value"];
const _hoisted_138 = { class: "flex items-center gap-2" };
const _hoisted_139 = {
  key: 0,
...
const _hoisted_140 = { class: "overflow-x-auto" };
const _hoisted_141 = { class: "min-w-full divide-y divide-slate-200 text-sm dark:divide-slate-800" };
const _hoisted_142 = { class: "bg-slate-50 dark:bg-slate-800/80" };
const _hoisted_143 = { class: "px-2 py-2 text-left" };
const _hoisted_144 = { class: "opacity-70" };
const _hoisted_145 = { class: "px-2 py-2 text-left" };
const _hoisted_146 = { class: "opacity-70" };
const _hoisted_147 = { class: "px-2 py-2 text-left" };
const _hoisted_148 = { class: "opacity-70" };
const _hoisted_149 = { class: "px-2 py-2 text-left" };
const _hoisted_150 = { class: "opacity-70" };
const _hoisted_151 = { class: "px-2 py-2 text-left" };
const _hoisted_152 = { class: "opacity-70" };
const _hoisted_153 = { class: "px-2 py-2 text-left" };
const _hoisted_154 = { class: "opacity-70" };
const _hoisted_155 = { class: "px-2 py-2 text-right" };
const _hoisted_156 = { class: "opacity-70" };
const _hoisted_157 = { class: "px-2 py-2 text-right" };
const _hoisted_158 = { class: "opacity-70" };
const _hoisted_159 = { class: "px-2 py-2 text-center" };
const _hoisted_160 = { class: "opacity-70" };
const _hoisted_161 = { class: "divide-y divide-slate-100 dark:divide-slate-800" };
const _hoisted_162 = { key: 0 };
const _hoisted_163 = { class: "px-2 py-2" };
const _hoisted_164 = { class: "px-2 py-2 whitespace-nowrap" };
const _hoisted_165 = { class: "px-2 py-2" };
const _hoisted_166 = { class: "px-2 py-2" };
const _hoisted_167 = { class: "px-2 py-2" };
const _hoisted_168 = { key: 0 };
const _hoisted_169 = { key: 1 };
const _hoisted_170 = { class: "px-2 py-2" };
const _hoisted_171 = { key: 0 };
const _hoisted_172 = { key: 1 };
const _hoisted_173 = { class: "px-2 py-2 text-right" };
const _hoisted_174 = { class: "px-2 py-2 text-right" };
...
const _hoisted_178 = { class: "px-2 py-2 text-center" };
const _hoisted_179 = { class: "inline-flex gap-1" };
const _hoisted_180 = ["onClick"];
const _hoisted_181 = ["disabled", "onClick"];
const _hoisted_182 = { class: "flex items-center justify-between text-xs" };
const _hoisted_183 = { class: "text-slate-500 dark:text-slate-400" };
const _hoisted_184 = { class: "inline-flex items-center gap-2" };
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props) {
    ...
    const filteredSetHoldings = computed(() => {
      ...
      if (selectedPortfolioId === void 0) return holdingsWithMeta.value;
    ...
    async function fillSetCashTargetFromCurrent() {
      const portfolioId = toOptionalNumber(setCashForm.portfolio_id);
      if (!portfolioId) {
        const message2 = "Portfolio를 먼저 선택해주세요.";
        errorMessage.value = message2;
        appendSetActionLog("CASH", "ERROR", message2);
        return;
      }
      const currency = setCashForm.currency.trim().toUpperCase();
      if (currency.length !== 3) {
        const message2 = "Currency는 3자리 코드여야 합니다.";
        errorMessage.value = message2;
        appendSetActionLog("CASH", "ERROR", message2);
        return;
      }
      ...
      if (current === void 0) {
        const message2 = "선택한 포트폴리오/통화의 Auto Cash Balance를 찾지 못했습니다.";
        errorMessage.value = message2;
        appendSetActionLog("CASH", "ERROR", message2);
        return;
      }
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("section", _hoisted_1, [
        _cache[177] || (_cache[177] = _createElementVNode("header", { class: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900" }, [
          ...
          !transferCollapsed.value ? (_openBlock(), _createElementBlock("div", _hoisted_5, [
            _createElementVNode("div", _hoisted_6, [
              _createElementVNode("label", _hoisted_7, [
                _cache[88] || (_cache[88] = _createTextVNode("From Portfolio ", -1)),
                _withDirectives(_createElementVNode("select", {
                  ...
                  _cache[87] || (_cache[87] = _createElementVNode("option", { value: "" }, "Select", -1)),
              ...
              _createElementVNode("label", _hoisted_9, [
                _cache[90] || (_cache[90] = _createTextVNode("To Portfolio ", -1)),
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => transferForm.to_portfolio_id = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, [
                  _cache[89] || (_cache[89] = _createElementVNode("option", { value: "" }, "Select", -1)),
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                    return _openBlock(), _createElementBlock("option", {
                      key: `to-${p.id}`,
                      value: String(p.id)
              ...
              _createElementVNode("label", _hoisted_12, [
                _cache[92] || (_cache[92] = _createTextVNode("Currency ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_13, [
                _cache[93] || (_cache[93] = _createTextVNode("Executed At (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_14, [
                _cache[94] || (_cache[94] = _createTextVNode("Memo (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
            ...
            _createElementVNode("div", _hoisted_15, [
              _createElementVNode("label", _hoisted_16, [
                ...
                _cache[95] || (_cache[95] = _createElementVNode("span", null, "Auto apply to cash holding", -1))
              ]),
              _createElementVNode("label", _hoisted_17, [
                ...
                _cache[96] || (_cache[96] = _createElementVNode("span", null, "Auto apply to net contribution", -1))
              ])
            ]),
          ...
          !entryCollapsed.value ? (_openBlock(), _createElementBlock("div", _hoisted_24, [
            _createElementVNode("div", _hoisted_25, [
              _createElementVNode("label", _hoisted_26, [
                _cache[99] || (_cache[99] = _createTextVNode("Portfolio ", -1)),
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => form.portfolio_id = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, [
                  _cache[98] || (_cache[98] = _createElementVNode("option", { value: "" }, "Select", -1)),
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                    return _openBlock(), _createElementBlock("option", {
                      key: p.id,
                      value: String(p.id)
              ...
              _createElementVNode("label", _hoisted_28, [
                _cache[100] || (_cache[100] = _createTextVNode("Type ", -1)),
                _withDirectives(_createElementVNode("select", {
                  ...
                  (_openBlock(), _createElementBlock(_Fragment, null, _renderList(tradeTypes, (type) => {
                    return _createElementVNode("option", {
                      key: type,
                      value: type
                    }, _toDisplayString(tradeTypeLabelMap[type]), 9, _hoisted_29);
                  }), 64))
                ], 512), [
              ...
              _createElementVNode("label", _hoisted_30, [
                _cache[102] || (_cache[102] = _createTextVNode("Asset ", -1)),
                _withDirectives(_createElementVNode("select", {
                  ...
                  _cache[101] || (_cache[101] = _createElementVNode("option", { value: "" }, "Select", -1)),
              ...
              _createElementVNode("label", _hoisted_33, [
                _cache[104] || (_cache[104] = _createTextVNode("Liability ", -1)),
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => form.liability_id = $event),
                  disabled: !isLoanTxn.value,
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm disabled:opacity-60 dark:border-slate-700 dark:bg-slate-950"
                }, [
                  _cache[103] || (_cache[103] = _createElementVNode("option", { value: "" }, "Select", -1)),
                ...
                _cache[105] || (_cache[105] = _createElementVNode("p", { class: "mt-1 text-[11px] normal-case text-slate-500 dark:text-slate-400" }, "Shows liabilities linked to selected portfolio.", -1))
              ]),
              _createElementVNode("label", _hoisted_36, [
                _cache[106] || (_cache[106] = _createTextVNode("Currency ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_37, [
                _cache[107] || (_cache[107] = _createTextVNode("Quantity ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_39, [
                _cache[108] || (_cache[108] = _createTextVNode("Unit Price ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_41, [
                ...
                amountHint.value ? (_openBlock(), _createElementBlock("p", _hoisted_43, _toDisplayString(amountHint.value), 1)) : _createCommentVNode("", true)
              ]),
              _createElementVNode("label", _hoisted_44, [
                _cache[109] || (_cache[109] = _createTextVNode("Fee (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
                ...
                _cache[110] || (_cache[110] = _createElementVNode("p", { class: "mt-1 text-[11px] normal-case text-slate-500 dark:text-slate-400" }, " BUY/SELL create 시 fee > 0 이면 FEE 거래가 추가로 생성됩니다. ", -1))
              ]),
              _createElementVNode("label", _hoisted_46, [
                _cache[112] || (_cache[112] = _createTextVNode("Source ", -1)),
                _withDirectives(_createElementVNode("select", {
            ...
            _createElementVNode("label", _hoisted_47, [
              _cache[113] || (_cache[113] = _createTextVNode("Memo ", -1)),
              _withDirectives(_createElementVNode("input", {
            ...
            _createElementVNode("div", _hoisted_48, [
              _createElementVNode("label", _hoisted_49, [
                ...
                _cache[114] || (_cache[114] = _createElementVNode("span", null, "Auto apply to cash holding", -1))
              ]),
              _createElementVNode("label", _hoisted_51, [
                ...
                _cache[115] || (_cache[115] = _createElementVNode("span", null, "Auto apply to net contribution", -1))
              ])
            ]),
            _createElementVNode("div", _hoisted_52, [
              _createElementVNode("button", {
                ...
                onClick: submit
              }, _toDisplayString(saving.value ? "Saving..." : editingId.value ? "Update Trade" : "Create Trade"), 9, _hoisted_53),
              _createElementVNode("button", {
                type: "button",
                class: "rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800",
                onClick: resetForm
              ...
              _createElementVNode("div", _hoisted_54, [
                _createElementVNode("button", {
                  ...
                  onClick: onRebuild
                }, _toDisplayString(rebuilding.value ? "Rebuilding..." : "Rebuild Ledger Sync"), 9, _hoisted_55),
                _cache[117] || (_cache[117] = _createElementVNode("button", {
                  type: "button",
                ...
                _createElementVNode("div", _hoisted_56, [
                  _cache[116] || (_cache[116] = _createElementVNode("p", { class: "font-semibold text-slate-900 dark:text-slate-100" }, "Rebuild Ledger Sync 사용 가이드", -1)),
        ...
        _createElementVNode("article", _hoisted_58, [
          _createElementVNode("div", _hoisted_59, [
            _cache[118] || (_cache[118] = _createElementVNode("div", null, [
            ...
            _createElementVNode("button", {
              ...
              onClick: _cache[23] || (_cache[23] = ($event) => setActionsCollapsed.value = !setActionsCollapsed.value)
            }, _toDisplayString(setActionsCollapsed.value ? "Expand" : "Collapse"), 9, _hoisted_60)
          ]),
          !setActionsCollapsed.value ? (_openBlock(), _createElementBlock("div", _hoisted_61, [
            _createElementVNode("div", _hoisted_62, [
              _createElementVNode("button", {
                ...
                onClick: _cache[24] || (_cache[24] = ($event) => setActionTab.value = "PORTFOLIO")
              ...
              _createElementVNode("button", {
                ...
                onClick: _cache[25] || (_cache[25] = ($event) => setActionTab.value = "HOLDING")
              ...
              _createElementVNode("button", {
                ...
                onClick: _cache[26] || (_cache[26] = ($event) => setActionTab.value = "LIABILITY")
              ...
              _createElementVNode("button", {
                ...
                onClick: _cache[27] || (_cache[27] = ($event) => setActionTab.value = "CASH")
              }, " Auto Cash Balance Set ", 2)
            ]),
            setActionTab.value === "PORTFOLIO" ? (_openBlock(), _createElementBlock("div", _hoisted_63, [
              _createElementVNode("div", _hoisted_64, [
                _createElementVNode("label", _hoisted_65, [
                  _cache[120] || (_cache[120] = _createTextVNode("Portfolio ", -1)),
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => setPortfolioForm.portfolio_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    _cache[119] || (_cache[119] = _createElementVNode("option", { value: "" }, "Select", -1)),
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-pf-${p.id}`,
                        value: String(p.id)
                      }, "#" + _toDisplayString(p.id) + " " + _toDisplayString(p.name), 9, _hoisted_66);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_67, [
                  _cache[121] || (_cache[121] = _createTextVNode("Effective At (KST) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => setPortfolioForm.effective_at = $event),
                    type: "datetime-local",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_68, [
                  _cache[122] || (_cache[122] = _createTextVNode("Cumulative Deposit ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => setPortfolioForm.cumulative_deposit_amount = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_69, [
                  _cache[123] || (_cache[123] = _createTextVNode("Cumulative Withdrawal ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => setPortfolioForm.cumulative_withdrawal_amount = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_70, [
                _cache[124] || (_cache[124] = _createTextVNode("Reason (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => setPortfolioForm.reason = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_71, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => setPortfolioForm.rebaseline_all_history = $event),
                  type: "checkbox",
                  class: "h-4 w-4"
                }, null, 512), [
                  [_vModelCheckbox, setPortfolioForm.rebaseline_all_history]
                ]),
                _cache[125] || (_cache[125] = _createElementVNode("span", null, "Rebaseline all history (기준시각 무시)", -1))
              ]),
              _createElementVNode("div", null, [
                ...
                }, _toDisplayString(setActionSaving.value ? "Applying..." : "Apply Portfolio Net Contribution Set"), 9, _hoisted_72)
              ]),
              _createElementVNode("div", _hoisted_73, [
                _createElementVNode("div", _hoisted_74, [
                  _cache[126] || (_cache[126] = _createElementVNode("p", { class: "font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" }, "Recent Logs", -1)),
                  _createElementVNode("button", {
                    type: "button",
                    ...
                    onClick: _cache[34] || (_cache[34] = ($event) => clearSetActionLogs("PORTFOLIO"))
                  }, " Clear ")
                ]),
                setActionLogs.PORTFOLIO.length ? (_openBlock(), _createElementBlock("ul", _hoisted_75, [
                ...
                ])) : (_openBlock(), _createElementBlock("p", _hoisted_76, "No executions yet."))
              ])
            ])) : setActionTab.value === "HOLDING" ? (_openBlock(), _createElementBlock("div", _hoisted_77, [
              _createElementVNode("div", _hoisted_78, [
                _createElementVNode("label", _hoisted_79, [
                  _cache[128] || (_cache[128] = _createTextVNode("Portfolio (filter) ", -1)),
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => setHoldingForm.portfolio_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    _cache[127] || (_cache[127] = _createElementVNode("option", { value: "" }, "All", -1)),
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-h-pf-${p.id}`,
                        value: String(p.id)
                      }, "#" + _toDisplayString(p.id) + " " + _toDisplayString(p.name), 9, _hoisted_80);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_81, [
                  _cache[130] || (_cache[130] = _createTextVNode("Holding ", -1)),
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[36] || (_cache[36] = ($event) => setHoldingForm.holding_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    ...
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredSetHoldings.value, (h) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-h-${h.id}`,
                        value: String(h.id)
                      }, " #" + _toDisplayString(h.id) + " " + _toDisplayString(h.portfolio_name) + " / " + _toDisplayString(h.asset_name) + _toDisplayString(h.asset_symbol ? ` (${h.asset_symbol})` : ""), 9, _hoisted_82);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_83, [
                  _cache[131] || (_cache[131] = _createTextVNode("Effective At (KST) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => setHoldingForm.effective_at = $event),
                    type: "datetime-local",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_84, [
                  _cache[132] || (_cache[132] = _createTextVNode("Quantity ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => setHoldingForm.quantity = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_85, [
                  _cache[133] || (_cache[133] = _createTextVNode("Avg Cost ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => setHoldingForm.avg_cost = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_86, [
                  _cache[134] || (_cache[134] = _createTextVNode("Avg Cost Currency ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => setHoldingForm.avg_cost_currency = $event),
                    maxlength: "3",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm uppercase dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                    [_vModelText, setHoldingForm.avg_cost_currency]
                  ])
                ]),
                _createElementVNode("label", _hoisted_87, [
                  _cache[135] || (_cache[135] = _createTextVNode("Cost Basis (optional) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => setHoldingForm.cost_basis_total = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_88, [
                  _cache[136] || (_cache[136] = _createTextVNode("Cost Basis Currency ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[42] || (_cache[42] = ($event) => setHoldingForm.cost_basis_currency = $event),
                    maxlength: "3",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm uppercase dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                    [_vModelText, setHoldingForm.cost_basis_currency]
                  ])
                ])
              ]),
              selectedSetHolding.value?.is_auto_cash ? (_openBlock(), _createElementBlock("p", _hoisted_89, " Auto Cash Balance는 ledger-derived입니다. Trade의 BALANCE_SET/DEPOSIT/WITHDRAW/ADJUSTMENT를 사용하세요. ")) : _createCommentVNode("", true),
              _createElementVNode("label", _hoisted_90, [
                _cache[137] || (_cache[137] = _createTextVNode("Reason (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[43] || (_cache[43] = ($event) => setHoldingForm.reason = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_91, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => setHoldingForm.rebaseline_all_history = $event),
                  type: "checkbox",
                  class: "h-4 w-4"
                }, null, 512), [
                  [_vModelCheckbox, setHoldingForm.rebaseline_all_history]
                ]),
                _cache[138] || (_cache[138] = _createElementVNode("span", null, "Rebaseline all history (기준시각 무시)", -1))
              ]),
              _createElementVNode("div", null, [
                _createElementVNode("button", {
                  type: "button",
                ...
                }, _toDisplayString(setActionSaving.value ? "Applying..." : "Apply Holding Position Set"), 9, _hoisted_92)
              ]),
              _createElementVNode("div", _hoisted_93, [
                _createElementVNode("div", _hoisted_94, [
                  _cache[139] || (_cache[139] = _createElementVNode("p", { class: "font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" }, "Recent Logs", -1)),
                  _createElementVNode("button", {
                    type: "button",
                    class: "rounded-lg border border-slate-300 px-2 py-1 text-[11px] font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800",
                    onClick: _cache[45] || (_cache[45] = ($event) => clearSetActionLogs("HOLDING"))
                  }, " Clear ")
                ]),
                setActionLogs.HOLDING.length ? (_openBlock(), _createElementBlock("ul", _hoisted_95, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(setActionLogs.HOLDING, (line) => {
                    return _openBlock(), _createElementBlock("li", {
                      key: `set-log-holding-${line}`
                    }, _toDisplayString(line), 1);
                  }), 128))
                ])) : (_openBlock(), _createElementBlock("p", _hoisted_96, "No executions yet."))
              ])
            ])) : setActionTab.value === "LIABILITY" ? (_openBlock(), _createElementBlock("div", _hoisted_97, [
              _createElementVNode("div", _hoisted_98, [
                _createElementVNode("label", _hoisted_99, [
                  _cache[141] || (_cache[141] = _createTextVNode("Portfolio (filter) ", -1)),
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[46] || (_cache[46] = ($event) => setLiabilityForm.portfolio_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    _cache[140] || (_cache[140] = _createElementVNode("option", { value: "" }, "All", -1)),
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-l-pf-${p.id}`,
                        value: String(p.id)
                      }, "#" + _toDisplayString(p.id) + " " + _toDisplayString(p.name), 9, _hoisted_100);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_101, [
                  _cache[143] || (_cache[143] = _createTextVNode("Liability ", -1)),
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[47] || (_cache[47] = ($event) => setLiabilityForm.liability_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    _cache[142] || (_cache[142] = _createElementVNode("option", { value: "" }, "Select", -1)),
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredSetLiabilities.value, (l) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-l-${l.id}`,
                        value: String(l.id)
                      }, " #" + _toDisplayString(l.id) + " " + _toDisplayString(l.name) + " (" + _toDisplayString(l.currency) + ") ", 9, _hoisted_102);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_103, [
                  _cache[144] || (_cache[144] = _createTextVNode("Effective At (KST) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[48] || (_cache[48] = ($event) => setLiabilityForm.effective_at = $event),
                    type: "datetime-local",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_104, [
                  _cache[145] || (_cache[145] = _createTextVNode("Outstanding Balance ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[49] || (_cache[49] = ($event) => setLiabilityForm.outstanding_balance = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                ...
                _createElementVNode("label", _hoisted_105, [
                  _cache[146] || (_cache[146] = _createTextVNode("Interest Rate (optional) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[50] || (_cache[50] = ($event) => setLiabilityForm.interest_rate = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_106, [
                _cache[147] || (_cache[147] = _createTextVNode("Reason (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[51] || (_cache[51] = ($event) => setLiabilityForm.reason = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_107, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[52] || (_cache[52] = ($event) => setLiabilityForm.rebaseline_all_history = $event),
                  type: "checkbox",
                  class: "h-4 w-4"
                }, null, 512), [
                  [_vModelCheckbox, setLiabilityForm.rebaseline_all_history]
                ]),
                _cache[148] || (_cache[148] = _createElementVNode("span", null, "Rebaseline all history (기준시각 무시)", -1))
              ]),
              _createElementVNode("div", null, [
                _createElementVNode("button", {
                  type: "button",
                ...
                }, _toDisplayString(setActionSaving.value ? "Applying..." : "Apply Liability Balance Set"), 9, _hoisted_108)
              ]),
              _createElementVNode("div", _hoisted_109, [
                _createElementVNode("div", _hoisted_110, [
                  _cache[149] || (_cache[149] = _createElementVNode("p", { class: "font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" }, "Recent Logs", -1)),
                  _createElementVNode("button", {
                    type: "button",
                    class: "rounded-lg border border-slate-300 px-2 py-1 text-[11px] font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800",
                    onClick: _cache[53] || (_cache[53] = ($event) => clearSetActionLogs("LIABILITY"))
                  }, " Clear ")
                ]),
                setActionLogs.LIABILITY.length ? (_openBlock(), _createElementBlock("ul", _hoisted_111, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(setActionLogs.LIABILITY, (line) => {
                    return _openBlock(), _createElementBlock("li", {
                      key: `set-log-liability-${line}`
                    }, _toDisplayString(line), 1);
                  }), 128))
                ])) : (_openBlock(), _createElementBlock("p", _hoisted_112, "No executions yet."))
              ])
              ...
              _createElementVNode("div", _hoisted_114, [
                _createElementVNode("label", _hoisted_115, [
                  ...
                  _withDirectives(_createElementVNode("select", {
                    "onUpdate:modelValue": _cache[54] || (_cache[54] = ($event) => setCashForm.portfolio_id = $event),
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, [
                    _cache[150] || (_cache[150] = _createElementVNode("option", { value: "" }, "Select", -1)),
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(portfolios.value, (p) => {
                      return _openBlock(), _createElementBlock("option", {
                        key: `set-c-pf-${p.id}`,
                        value: String(p.id)
                      }, "#" + _toDisplayString(p.id) + " " + _toDisplayString(p.name), 9, _hoisted_116);
                    }), 128))
                  ], 512), [
                ...
                _createElementVNode("label", _hoisted_117, [
                  _cache[152] || (_cache[152] = _createTextVNode("Currency ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[55] || (_cache[55] = ($event) => setCashForm.currency = $event),
                    maxlength: "3",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm uppercase dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
                    [_vModelText, setCashForm.currency]
                  ])
                ]),
                _createElementVNode("label", _hoisted_118, [
                  _cache[153] || (_cache[153] = _createTextVNode("Target Balance ", -1)),
                  _createElementVNode("div", _hoisted_119, [
                    _withDirectives(_createElementVNode("input", {
                      "onUpdate:modelValue": _cache[56] || (_cache[56] = ($event) => setCashForm.target_balance = $event),
                      class: "w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                    }, null, 512), [
                    ...
                    _createElementVNode("button", {
                      ...
                      onClick: fillSetCashTargetFromCurrent
                    }, " Use Current ")
                  ])
                ]),
                _createElementVNode("label", _hoisted_120, [
                  _cache[154] || (_cache[154] = _createTextVNode("Effective At (KST) ", -1)),
                  _withDirectives(_createElementVNode("input", {
                    "onUpdate:modelValue": _cache[57] || (_cache[57] = ($event) => setCashForm.effective_at = $event),
                    type: "datetime-local",
                    class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                  }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_121, [
                _cache[155] || (_cache[155] = _createTextVNode("Memo (optional) ", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[58] || (_cache[58] = ($event) => setCashForm.memo = $event),
                  class: "mt-1 w-full rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
                }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_122, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[59] || (_cache[59] = ($event) => setCashForm.auto_fill_apply = $event),
                  type: "checkbox",
                  class: "h-4 w-4"
                }, null, 512), [
                  [_vModelCheckbox, setCashForm.auto_fill_apply]
                ]),
                _cache[156] || (_cache[156] = _createElementVNode("span", null, "Auto Fill + Apply (Use Current 클릭 시 바로 실행)", -1))
              ]),
              _cache[158] || (_cache[158] = _createElementVNode("p", { class: "rounded-lg border border-cyan-300 bg-cyan-50 px-3 py-2 text-xs text-cyan-800 dark:border-cyan-700 dark:bg-cyan-900/20 dark:text-cyan-300" }, " 기존 BALANCE_SET 거래를 생성하여 현금 잔액을 목표값으로 맞춥니다. (Manual Trade Entry의 BALANCE_SET은 그대로 유지) ", -1)),
              _createElementVNode("div", null, [
                _createElementVNode("button", {
                  type: "button",
                  class: "rounded-lg bg-violet-600 px-4 py-2 text-sm font-semibold text-white hover:bg-violet-500 disabled:opacity-60",
                ...
                }, _toDisplayString(setActionSaving.value ? "Applying..." : "Apply Auto Cash Balance Set"), 9, _hoisted_123)
              ]),
              _createElementVNode("div", _hoisted_124, [
                _createElementVNode("div", _hoisted_125, [
                  _cache[157] || (_cache[157] = _createElementVNode("p", { class: "font-semibold uppercase tracking-[0.08em] text-slate-600 dark:text-slate-300" }, "Recent Logs", -1)),
                  _createElementVNode("button", {
                    type: "button",
                    class: "rounded-lg border border-slate-300 px-2 py-1 text-[11px] font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800",
                    onClick: _cache[60] || (_cache[60] = ($event) => clearSetActionLogs("CASH"))
                  }, " Clear ")
                ]),
                setActionLogs.CASH.length ? (_openBlock(), _createElementBlock("ul", _hoisted_126, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(setActionLogs.CASH, (line) => {
                    return _openBlock(), _createElementBlock("li", {
                      key: `set-log-cash-${line}`
                    }, _toDisplayString(line), 1);
                  }), 128))
                ])) : (_openBlock(), _createElementBlock("p", _hoisted_127, "No executions yet."))
              ])
            ]))
          ])) : _createCommentVNode("", true)
        ]),
        errorMessage.value ? (_openBlock(), _createElementBlock("article", _hoisted_128, _toDisplayString(errorMessage.value), 1)) : _createCommentVNode("", true),
        successMessage.value ? (_openBlock(), _createElementBlock("article", _hoisted_129, _toDisplayString(successMessage.value), 1)) : _createCommentVNode("", true),
        _createElementVNode("article", _hoisted_130, [
          _createElementVNode("div", _hoisted_131, [
            ...
            _createElementVNode("button", {
              ...
              onClick: _cache[61] || (_cache[61] = ($event) => journalCollapsed.value = !journalCollapsed.value)
            }, _toDisplayString(journalCollapsed.value ? "Expand" : "Collapse"), 9, _hoisted_132)
          ]),
          !journalCollapsed.value ? (_openBlock(), _createElementBlock("div", _hoisted_133, [
            _createElementVNode("div", _hoisted_134, [
              _createElementVNode("button", {
                ...
                onClick: _cache[62] || (_cache[62] = ($event) => setQuickGroup("ALL"))
              }, " ALL ", 2),
              _createElementVNode("button", {
                type: "button",
                ...
                onClick: _cache[63] || (_cache[63] = ($event) => setQuickGroup("LOAN"))
              }, " LOAN ", 2),
              _createElementVNode("button", {
                type: "button",
                ...
                onClick: _cache[64] || (_cache[64] = ($event) => setQuickGroup("CASHFLOW"))
              }, " CASHFLOW ", 2),
              _createElementVNode("button", {
                type: "button",
                ...
                onClick: _cache[65] || (_cache[65] = ($event) => setQuickGroup("BUYSELL"))
              }, " BUYSELL ", 2)
            ]),
            _createElementVNode("div", _hoisted_135, [
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[66] || (_cache[66] = ($event) => filters.q = $event),
                placeholder: "Search...",
              ...
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[67] || (_cache[67] = ($event) => filters.portfolio_id = $event),
                type: "number",
                min: "1",
              ...
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[68] || (_cache[68] = ($event) => filters.asset_id = $event),
                type: "number",
                min: "1",
              ...
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[69] || (_cache[69] = ($event) => filters.liability_id = $event),
                type: "number",
                min: "1",
              ...
              _withDirectives(_createElementVNode("select", {
                "onUpdate:modelValue": _cache[70] || (_cache[70] = ($event) => filters.txn_type = $event),
                class: "rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
              }, [
                _cache[160] || (_cache[160] = _createElementVNode("option", { value: "" }, "ALL TYPES", -1)),
                (_openBlock(), _createElementBlock(_Fragment, null, _renderList(tradeTypes, (type) => {
                  return _createElementVNode("option", {
                    key: type,
                    value: type
                  }, _toDisplayString(tradeTypeLabelMap[type]), 9, _hoisted_136);
                }), 64))
              ], 512), [
                [_vModelSelect, filters.txn_type]
              ]),
              _withDirectives(_createElementVNode("select", {
                "onUpdate:modelValue": _cache[71] || (_cache[71] = ($event) => filters.status = $event),
                class: "rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
              }, [
                _cache[161] || (_cache[161] = _createElementVNode("option", { value: "" }, "ALL STATUS", -1)),
                (_openBlock(), _createElementBlock(_Fragment, null, _renderList(statusOptions, (status) => {
                  return _createElementVNode("option", {
                    key: status,
                    value: status
                  }, _toDisplayString(status), 9, _hoisted_137);
                }), 64))
              ], 512), [
                [_vModelSelect, filters.status]
              ]),
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[72] || (_cache[72] = ($event) => filters.from = $event),
                type: "date",
                class: "rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
              }, null, 512), [
              ...
              _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": _cache[73] || (_cache[73] = ($event) => filters.to = $event),
                type: "date",
                class: "rounded-lg border border-slate-300 px-2 py-2 text-sm dark:border-slate-700 dark:bg-slate-950"
              }, null, 512), [
            ...
            _createElementVNode("div", _hoisted_138, [
              ...
              journalAutoSearchPending.value ? (_openBlock(), _createElementBlock("span", _hoisted_139, [..._cache[162] || (_cache[162] = [
            ...
            _createElementVNode("div", _hoisted_140, [
              _createElementVNode("table", _hoisted_141, [
                _createElementVNode("thead", _hoisted_142, [
                  _createElementVNode("tr", null, [
                    _createElementVNode("th", _hoisted_143, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[74] || (_cache[74] = ($event) => toggleSort("id"))
                      }, [
                        _cache[163] || (_cache[163] = _createTextVNode(" # ", -1)),
                        _createElementVNode("span", _hoisted_144, _toDisplayString(sortIndicator("id")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_145, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[75] || (_cache[75] = ($event) => toggleSort("executed_at"))
                      }, [
                        _cache[164] || (_cache[164] = _createTextVNode(" Time ", -1)),
                        _createElementVNode("span", _hoisted_146, _toDisplayString(sortIndicator("executed_at")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_147, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[76] || (_cache[76] = ($event) => toggleSort("txn_type"))
                      }, [
                        _cache[165] || (_cache[165] = _createTextVNode(" Type ", -1)),
                        _createElementVNode("span", _hoisted_148, _toDisplayString(sortIndicator("txn_type")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_149, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[77] || (_cache[77] = ($event) => toggleSort("portfolio_name"))
                      }, [
                        _cache[166] || (_cache[166] = _createTextVNode(" Portfolio ", -1)),
                        _createElementVNode("span", _hoisted_150, _toDisplayString(sortIndicator("portfolio_name")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_151, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[78] || (_cache[78] = ($event) => toggleSort("asset_name"))
                      }, [
                        _cache[167] || (_cache[167] = _createTextVNode(" Asset ", -1)),
                        _createElementVNode("span", _hoisted_152, _toDisplayString(sortIndicator("asset_name")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_153, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[79] || (_cache[79] = ($event) => toggleSort("liability_name"))
                      }, [
                        _cache[168] || (_cache[168] = _createTextVNode(" Liability ", -1)),
                        _createElementVNode("span", _hoisted_154, _toDisplayString(sortIndicator("liability_name")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_155, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[80] || (_cache[80] = ($event) => toggleSort("amount"))
                      }, [
                        _cache[169] || (_cache[169] = _createTextVNode(" Amount ", -1)),
                        _createElementVNode("span", _hoisted_156, _toDisplayString(sortIndicator("amount")), 1)
                      ])
                    ]),
                    _createElementVNode("th", _hoisted_157, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[81] || (_cache[81] = ($event) => toggleSort("amount_in_portfolio_currency"))
                      }, [
                        _cache[170] || (_cache[170] = _createTextVNode(" Amount(Base) ", -1)),
                        _createElementVNode("span", _hoisted_158, _toDisplayString(sortIndicator("amount_in_portfolio_currency")), 1)
                      ])
                    ]),
                    _cache[172] || (_cache[172] = _createElementVNode("th", { class: "px-2 py-2 text-center" }, "Auto Cash", -1)),
                    _cache[173] || (_cache[173] = _createElementVNode("th", { class: "px-2 py-2 text-center" }, "Auto Net Contribution", -1)),
                    _createElementVNode("th", _hoisted_159, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "inline-flex items-center gap-1 hover:underline",
                        onClick: _cache[82] || (_cache[82] = ($event) => toggleSort("status"))
                      }, [
                        _cache[171] || (_cache[171] = _createTextVNode(" Status ", -1)),
                        _createElementVNode("span", _hoisted_160, _toDisplayString(sortIndicator("status")), 1)
                      ])
                    ]),
                    _cache[174] || (_cache[174] = _createElementVNode("th", { class: "px-2 py-2 text-center" }, "Action", -1))
                  ])
                ]),
                _createElementVNode("tbody", _hoisted_161, [
                  !loading.value && trades.value.length === 0 ? (_openBlock(), _createElementBlock("tr", _hoisted_162, [..._cache[175] || (_cache[175] = [
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(trades.value, (row) => {
                    return _openBlock(), _createElementBlock("tr", {
                      ...
                      _createElementVNode("td", _hoisted_163, "#" + _toDisplayString(row.id), 1),
                      _createElementVNode("td", _hoisted_164, _toDisplayString(formatDateTime(row.executed_at)), 1),
                      _createElementVNode("td", _hoisted_165, _toDisplayString(row.txn_type), 1),
                      _createElementVNode("td", _hoisted_166, "#" + _toDisplayString(row.portfolio_id) + " " + _toDisplayString(row.portfolio_name ?? "-"), 1),
                      _createElementVNode("td", _hoisted_167, [
                        row.asset_id ? (_openBlock(), _createElementBlock("span", _hoisted_168, "#" + _toDisplayString(row.asset_id) + " " + _toDisplayString(row.asset_name ?? "-"), 1)) : (_openBlock(), _createElementBlock("span", _hoisted_169, "-"))
                      ]),
                      _createElementVNode("td", _hoisted_170, [
                        row.liability_id ? (_openBlock(), _createElementBlock("span", _hoisted_171, "#" + _toDisplayString(row.liability_id) + " " + _toDisplayString(row.liability_name ?? "-"), 1)) : (_openBlock(), _createElementBlock("span", _hoisted_172, "-"))
                      ]),
                      _createElementVNode("td", _hoisted_173, _toDisplayString(formatNumber(row.amount)) + " " + _toDisplayString(row.currency), 1),
                      _createElementVNode("td", _hoisted_174, _toDisplayString(formatNumber(row.amount_in_portfolio_currency)), 1),
                      _createElementVNode("td", _hoisted_175, _toDisplayString(row.auto_apply_cash_holding ? "ON" : "OFF"), 1),
                      _createElementVNode("td", _hoisted_176, _toDisplayString(row.auto_apply_portfolio_cashflow ? "ON" : "OFF"), 1),
                      ...
                      _createElementVNode("td", _hoisted_178, [
            ...
            _createElementVNode("div", _hoisted_182, [
              _createElementVNode("p", _hoisted_183, "total: " + _toDisplayString(total.value), 1),
              _createElementVNode("div", _hoisted_184, [
                _createElementVNode("button", {
                  ...
                  onClick: _cache[83] || (_cache[83] = ($event) => page.value -= 1)
                }, "Prev", 8, _hoisted_185),
                ...
                _createElementVNode("button", {
                  ...
                  onClick: _cache[84] || (_cache[84] = ($event) => page.value += 1)
                }, "Next", 8, _hoisted_186),
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[85] || (_cache[85] = ($event) => pageSize.value = $event),
