...
const {createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,normalizeClass:_normalizeClass,createTextVNode:_createTextVNode,renderList:_renderList,Fragment:_Fragment} = await importShared('vue');
...
const _hoisted_10 = { class: "mt-2 text-sm font-semibold text-slate-600 dark:text-slate-300" };
const _hoisted_11 = { class: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900" };
const _hoisted_12 = { class: "mt-1 text-2xl font-bold text-slate-900 dark:text-slate-100" };
const _hoisted_13 = { class: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900" };
const _hoisted_14 = { class: "mt-1 text-2xl font-bold text-slate-900 dark:text-slate-100" };
const _hoisted_15 = { class: "mt-2 text-sm font-semibold text-slate-600 dark:text-slate-300" };
        ...
        _createElementVNode("div", _hoisted_7, [
          _createElementVNode("article", _hoisted_8, [
            ...
            _createElementVNode("p", _hoisted_9, [
              _createTextVNode(_toDisplayString(formatCurrency(grossAssetsTotal.value, displayCurrency.value)) + " ", 1),
              _createElementVNode("span", {
                class: _normalizeClass(["text-base font-semibold", principalReturnPct.value >= 0 ? "text-emerald-600" : "text-rose-500"])
              }, " (" + _toDisplayString(formatPercent(principalReturnPct.value)) + ", " + _toDisplayString(formatSignedCurrency(principalProfitTotal.value, displayCurrency.value)) + ") ", 3)
            ]),
            _createElementVNode("p", _hoisted_10, " vs invested principal (" + _toDisplayString(formatCurrency(investedPrincipalTotal.value, displayCurrency.value)) + ") ", 1)
          ]),
          _createElementVNode("article", _hoisted_11, [
            _cache[2] || (_cache[2] = _createElementVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, "Liabilities", -1)),
            _createElementVNode("p", _hoisted_12, _toDisplayString(formatCurrency(liabilitiesTotal.value, displayCurrency.value)), 1),
            _cache[3] || (_cache[3] = _createElementVNode("p", { class: "mt-2 text-sm text-slate-600 dark:text-slate-300" }, "Included liabilities only", -1))
          ]),
          _createElementVNode("article", _hoisted_13, [
            _cache[4] || (_cache[4] = _createElementVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, "Net Assets (assets - liabilities)", -1)),
            _createElementVNode("p", _hoisted_14, [
              _createTextVNode(_toDisplayString(formatCurrency(netAssetsTotal.value, displayCurrency.value)) + " ", 1),
              _createElementVNode("span", {
                class: _normalizeClass(["text-base font-semibold", netAssetsReturnPct.value >= 0 ? "text-emerald-600" : "text-rose-500"])
              }, " (" + _toDisplayString(formatPercent(netAssetsReturnPct.value)) + ", " + _toDisplayString(formatSignedCurrency(netAssetsProfitTotal.value, displayCurrency.value)) + ") ", 3)
            ]),
            _createElementVNode("p", _hoisted_15, " vs principal - debt (" + _toDisplayString(formatCurrency(principalMinusDebtTotal.value, displayCurrency.value)) + ") ", 1)
          ])
        ]),
            ...
            topHoldings.value.length === 0 ? (_openBlock(), _createElementBlock("div", _hoisted_18, " No holdings data. ")) : (_openBlock(), _createElementBlock("ul", _hoisted_19, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(topHoldings.value, (item) => {
                return _openBlock(), _createElementBlock("li", {
                  ...
                  _createElementVNode("div", _hoisted_23, _toDisplayString(formatOptionalCurrency(item.current_price, item.current_price_currency || displayCurrency.value)) + " / " + _toDisplayString(formatOptionalCurrency(item.avg_price, item.current_price_currency || displayCurrency.value)), 1)
                ]);
              }), 128))
            ]))
          ]),
            ...
            topLiabilities.value.length === 0 ? (_openBlock(), _createElementBlock("div", _hoisted_25, " No liabilities data. ")) : (_openBlock(), _createElementBlock("ul", _hoisted_26, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(topLiabilities.value, (item) => {
                return _openBlock(), _createElementBlock("li", {
                  ...
                  _createElementVNode("div", _hoisted_30, _toDisplayString(formatCurrency(toNumber(item.outstanding_balance), item.currency || displayCurrency.value)), 1)
                ]);
              }), 128))
            ]))
          ])
